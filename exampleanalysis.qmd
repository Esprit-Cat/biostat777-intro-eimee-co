...
data_dictionary <- data.frame(
  Variable = c("ID", "Name", "Age", "Gender", "Grade", "Subject"),
  Description = c("ID", "Name", "Age", "Gender", "Grade", "Subject"),
  Type = c("Character", "Character", "Numeric", "Character", "Numeric", "Character"),
