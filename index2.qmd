...
Create a new public GitHub repository titled `biostat777-intro-<firstname>-<lastname>` (where you replace `<firstname>` with your first name and `<lastname>` with your last name) in your own personal GitHub account

`https://github.com/Esprit-Cat/biostat777-intro-eimee-co.git`
...
Deploy your website e.g. using [Quarto Pub](https://quarto.org/docs/publishing/quarto-pub.html), 

(https://github.com/Esprit-Cat/biostat777-intro-eimee-co.git), or 

https://esprit-cat.github.io/biostat777-intro-eimee-co/exampleanalysis.html
